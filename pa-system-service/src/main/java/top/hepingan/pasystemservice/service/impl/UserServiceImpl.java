...
import top.hepingan.pacommon.constants.OperateConstant;
import top.hepingan.pacommon.dto.UserPutDto;
import top.hepingan.pacommon.entity.User;
import top.hepingan.pacommon.enums.FileEnum;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public IPage<UserDataVo> getUserPageVo(int pageNum, String prompt) {
    ...
    @Override
    public void updateById(UserPutDto dto) {
