    ...
    <div class="cash-container cash-order">
      <div class="cash-info">
        <div class="cash-code-container" v-show="!showSucceed">
          <div>
            ...
            <div class="cash-pay-prompt">
              ...
              <div class="cash-pay-text">打开手机支付宝扫一扫完成付款</div>
            </div>
          </div>
          <div class="cash-order-data">
            <div class="cash-o-data">
              商品名称 :&nbsp;&nbsp;{{ outcome.productName }}
            </div>
            <div class="cash-o-data">
              商户订单号 :&nbsp;&nbsp;{{ outcome.ordersId }}
            </div>
            <div class="cash-o-data">
              创建时间 :&nbsp;&nbsp;{{ outcome.createdTime }}
            </div>
        ...
        <div class="pay-succeed" v-show="showSucceed">
          ...
          <div class="pay-succeed-title">谢谢你的赞赏!</div>
        </div>
        <div style="padding-bottom: 190px" v-show="showSucceed">
          <div class="cash-o-data pay-succeed-no">
            商户订单号 :&nbsp;&nbsp;{{ outcome.ordersId }}
          </div>
          <el-button
            size="large"
