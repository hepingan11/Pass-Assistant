...
export default defineComponent({
  ...
  setup() {
    const data = ref([
      {
        q: "如何获取Ai币",
        a: "可以通过序观看广告获取一定次数(无限制获取)或通过网页端打赏也可获得相应Ai币,还可以通过兑换码来兑换Ai币(点击头像进入兑换中心即可)",
      },
      {
      ...
      {
        q: "项目是什么开发的?部署难不难",
        a: "项目主要分为3个部分,Java(后端) UniApp() Vue(网页端) 实现, 中间件为 MySQL Redis,总体来说 很简单... 不懂群里可以问,另外v1.3.0可能会做Docker快速部署",
      },
    ]);
